...
import { FiCheckCircle, FiImage, FiLayout, FiLoader, FiPlus, FiUploadCloud, FiUser, FiX } from 'react-icons/fi';
import { addGalleryImages, getAllGalleryImages, getImageUrl } from '@/services/adminService';
import { AddImagesRequest, GalleryImage } from '@/types';
