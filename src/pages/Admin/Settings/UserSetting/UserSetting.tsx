...
import { getUserConfig, sendEmailVerificationCode, updateUserConfig, updateUserImages } from '@/services/adminService';
import { GalleryImage, UserConfig } from '@/types';
              ...
              <form onSubmit={handleSubmit} className='user-setting-form'>
                ...
                <div className='form-group'>
                  ...
                  <div className='tags-container'>
                    {typewriterContent.length === 0 && <div className='empty-tag-hint'>暂无内容，请添加</div>}
                ...
                <div className='form-group'>
                  ...
                  <p className='input-description'>
                    ...
                    {userHobbies.length > 0 && <span className='hobby-count'>当前已添加：{userHobbies.length}/10</span>}
                  </p>
                  <div className='tag-input-container'>
                    <input
                      type='text'
                  ...
                  <div className='tags-container'>
                    {userHobbies.length === 0 && <div className='empty-tag-hint'>暂无内容，请添加</div>}
